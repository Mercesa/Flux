...
namespace Flux
{
	namespace Gfx
	{
		namespace ShaderReflection
		{
			...
			static std::vector< ShaderResourceReflection> AddResourcesToList(
				const spirv_cross::CompilerGLSL& aCompiler,
				const spirv_cross::SmallVector<spirv_cross::Resource>& aResources,
				ShaderResourceType aType)
			{
			...
			static ShaderReflection Reflect(std::vector<char> aSpvbinary)
			{
