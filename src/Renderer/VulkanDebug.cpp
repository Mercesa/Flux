...
namespace vks
{
	...
	namespace debugmarker
	{
		...
		PFN_vkSetDebugUtilsObjectNameEXT pfnSetDebugUtilsObjectNameEXT = VK_NULL_HANDLE;
		...
		void setup(VkDevice device)
		{
			...
			pfnSetDebugUtilsObjectNameEXT = reinterpret_cast<PFN_vkSetDebugUtilsObjectNameEXT>(vkGetDeviceProcAddr(device, "vkSetDebugUtilsObjectNameEXT"));
		...
		void setPipelineLayoutName(VkDevice device, VkPipelineLayout pipelineLayout, const char* name)
		{
			...
			nameInfo.objectHandle = (int64_t)pipelineLayout;
